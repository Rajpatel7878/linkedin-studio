...
export function DraftCard({
  ...
  return (
    <Card3D depth={10} glowColor="rgba(56, 189, 248, 0.2)" className="glass-panel-3d border border-slate-800 shadow-xl flex flex-col justify-between overflow-hidden group">
      ...
      <div className="px-5 pt-4 pb-3 bg-blue-950/40 border-b border-blue-800/40 space-y-1">
      ...
      {/* Main Content Body */}
      <div className="p-5 flex-1 text-sm leading-relaxed text-slate-200 font-normal whitespace-pre-wrap select-text font-sans line-clamp-10">
        {draft.content}
      </div>

      {/* Footer Action Bar */}
      <div className="p-4 bg-slate-900/80 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-1.5">
          <button
            onClick={handleCopy}
            className="flex items-center gap-1 text-xs font-semibold text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/60 px-3 py-2 rounded-xl transition-all shadow-sm"
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs font-semibold text-purple-300 bg-purple-950/50 hover:bg-purple-900/60 border border-purple-500/30 px-3 py-2 rounded-xl transition-all shadow-sm"
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs font-semibold text-cyan-300 bg-blue-950/60 hover:bg-blue-900/70 border border-blue-500/40 px-3 py-2 rounded-xl transition-all shadow-sm"
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="flex items-center gap-1 text-xs font-semibold text-slate-300 hover:text-white bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/60 px-3 py-2 rounded-xl transition-all shadow-sm disabled:opacity-60"
          >
            {savedSuccess ? (
              <>
          ...
          <button
            ...
            className="btn-3d-primary flex items-center gap-1 text-xs font-bold text-white px-3.5 py-2 rounded-xl transition-all active:scale-95"
          >

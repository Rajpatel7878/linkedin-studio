        ...
        <Card3D depth={10} className="glass-panel-3d p-8 sm:p-10 border border-slate-800 shadow-2xl space-y-6">
          ...
          <div className="space-y-2.5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-bold text-xs shadow-md transition-all active:scale-98 disabled:opacity-60 cursor-pointer"
            >
              {isGoogleLoading ? (
            ...
            <button
              ...
              className="w-full btn-3d-primary flex items-center justify-center gap-3 py-3 px-4 rounded-xl text-white font-bold text-xs shadow-md active:scale-98 disabled:opacity-60 cursor-pointer"
            >
              {isLinkedInLoading ? (
          ...
          <form onSubmit={handleSubmitForm} className="space-y-3.5">
            ...
            <button
              ...
              className="w-full btn-3d-primary py-3 px-4 rounded-xl text-white font-bold text-xs shadow-md flex items-center justify-center gap-2 active:scale-98 disabled:opacity-50 mt-1 cursor-pointer"
            >
              {isLoading ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin text-white" />
